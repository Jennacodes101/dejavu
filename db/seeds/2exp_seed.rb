...
description_seed = [
  ...
  'the best board game cafe in Lisboa. Snacks are ok',
  'good place to chill',
...
address_seed = [
  'Calle De Embajadores, 28045 Madrid, provincia de Madrid, Espanha',
  'C. de Calatrava, 7, 28005 Madrid',
  '40.41086295424183, -3.7072753793356163',
  'R. da Palmeira 23, 1200-311 Lisboa, Portugal',
  'Esplanada Dom Carlos I, 1990-170 Lisboa, Distrito de Lisboa, Portugal',
  'Belem, lisboa, portugal',
  'Rua Professor Fernando Da Fonseca, 1600-618 Lisboa, Distrito de Lisboa, Portugal',
